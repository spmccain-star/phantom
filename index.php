  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .show-pill {
      ...
      background: rgba(176,26,28,0.75);
    ...
    /* ── Calendar ── */
    .calendar-section { max-width: 1100px; margin: 2rem auto 0; padding: 0 1.5rem 3rem; }
...
<body>
  ...
  <div class="hero">
    ...
    <div class="hero-overlay">
      <div class="hero-eyebrow">Saturday, July 18, 2026 &nbsp;·&nbsp; San Antonio, TX</div>
      <div class="hero-title">Come watch Mateo perform!</div>
      <div class="hero-sub">Phantom Regiment · <em>Bloodline</em> · DCI Southwestern Championship</div>
